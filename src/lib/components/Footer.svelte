<footer class="bg-[#050505] text-white pt-24 pb-12 border-t border-white/10">
    <div class="container mx-auto px-6">
        ...
        <div class="grid grid-cols-2 md:grid-cols-6 gap-8 mb-16 border-t border-white/10 pt-16">
            ...
            <div>
                <h4 class="text-xs font-semibold text-gray-500 uppercase tracking-wider mb-4">Features</h4>
                <ul class="space-y-3 text-sm text-gray-400">
                    <li><a href="#" class="hover:text-white">Performance</a></li>
                    <li><a href="#" class="hover:text-white">Security</a></li>
                    <li><a href="#" class="hover:text-white">Backups</a></li>
                    <li><a href="#" class="hover:text-white">Staging</a></li>
                    <li><a href="#" class="hover:text-white">CDN</a></li>
                    <li><a href="#" class="hover:text-white">SSL Certificates</a></li>
                </ul>
            </div>
            ...
            <div>
                ...
                <ul class="space-y-3 text-sm text-gray-400">
                    ...
                    <li><a href="#" class="hover:text-white">For E-commerce</a></li>
                    <li><a href="#" class="hover:text-white">For Businesses</a></li>
                    <li><a href="#" class="hover:text-white">For Developers</a></li>
                    <li><a href="#" class="hover:text-white">Migrations</a></li>
                </ul>
            </div>
